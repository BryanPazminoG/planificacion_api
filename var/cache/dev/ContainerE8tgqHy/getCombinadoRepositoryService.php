 ...
 */
class getCombinadoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CombinadoRepository' shared autowired service.
     *
     * @return \App\Repository\CombinadoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CombinadoRepository.php';

        return $container->privates['App\\Repository\\CombinadoRepository'] = new \App\Repository\CombinadoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
